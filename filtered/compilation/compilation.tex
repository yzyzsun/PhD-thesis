...
\end{subfigure}
\caption{Simplified JavaScript code for \texttt{\string{ x = self.y \string}}.}
\end{figure}
...
new (trait [this: Rcd] => { x = self.y; y = 48 })
\end{lstlisting}
...
three code snippets generated for the field \lstinline|{ x = self.y }|.
...
field is wrapped in a getter, and thus the computation of \lstinline{self.y} is
