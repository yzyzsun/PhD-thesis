...
\lstdefinelanguage{CP}{
  keywords={case,else,extends,false,fix,forall,if,implements,inherits,interface,in,let,letrec,new,null,open,override,switch,then,toString,trait,true,type,undefined,with,Bool,Bot,Double,Int,Null,String,Top,Trait},
  alsoother={@},
  comment=[l]{--},
  morecomment=[n]{\{-}{-\}},
  string=[b]",
...
\newcommand{\lambdaiu}{\texorpdfstring{$\lambda_\mathsf{iu}$}{λᵢᵤ}\xspace}
