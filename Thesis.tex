...
\lstdefinelanguage{CP}{
  keywords={as,case,else,extends,false,fix,fold,forall,if,implements,inherits,interface,in,let,letrec,new,null,open,override,ref,super,switch,then,toString,trait,true,type,undefined,unfold,with,Bool,Bot,Double,Int,Null,Ref,String,Top,Trait},
  alsoother={@},
  comment=[l]{--},
  morecomment=[n]{\{-}{-\}},
  string=[b]",
